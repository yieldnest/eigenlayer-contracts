...
//             for(uint256 j = 0; j < stakerDeposits[i].permitInfos.length; j++) {
//                 PermitInfo memory permitInfo = stakerDeposits[i].permitInfos[j];
//                 StrategyInfo memory strategyInfo = stakerDeposits[i].strategyInfos[j];

//                 // Permit
//                 StrategyToken(address(strategyInfo.token)).permit(
//                     permitInfo.owner,
//                     permitInfo.spender,
//                     permitInfo.value,
//                     permitInfo.deadline,
...
//                 // Seed Staker
//                 strategyInfo.token.transfer(address(strategyInfo.staker), strategyInfo.amount);
